                        ...
                        <BoxShadow setting={shadowOpt}>
                            <View style={{ flex: 1 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#fff', height: 49, paddingLeft: 10, marginVertical: 5, borderRadius: 5, borderBottomEndRadius: 0, borderBottomStartRadius: 0,  }}>
                                    ...
                                    <Image source={require('../../../Global/asset/Image/components/Mandiri.png')} style={{ width: null, height: null, flex: 1, resizeMode: 'contain'}}/>
                                </View>
                                </View>
                        </BoxShadow>
                        <BoxShadow setting={shadowOpttt}>
                            <View style={{ flex: 1 }}>
                                <View style={{ flexDirection: 'row', backgroundColor: '#fff', height: 49, paddingLeft: 10, marginVertical: 0, borderRadius: 0, justifyContent: 'center' }}>
                                    ...
                                    <Image source={require('../../../Global/asset/Image/components/bca.png')} style={{ width: null, height: null, flex: 1, resizeMode: 'contain'}}/>
                                </View>
                            </View>
                        </BoxShadow>
                        <BoxShadow setting={shadowOpttt}>
                            <View style={{ flex: 1 }}>
                                <View style={{ flexDirection: 'row', backgroundColor: '#fff', height: 49, paddingLeft: 10, marginVertical: 0, borderRadius: 0, justifyContent: 'center' }}>
                                    ...
                                    <Image source={require('../../../Global/asset/Image/components/BRI.png')} style={{ width: null, height: null, flex: 1, resizeMode: 'contain'}}/>
                                </View>
                            </View>
                        </BoxShadow>
                        ...
                        <BoxShadow setting={shadowOpt}>
                            <View style={{ flex: 1 }}>
                                <View style={{ flexDirection: 'row', backgroundColor: '#fff', height: 49, paddingLeft: 10, marginVertical: 5, borderRadius: 5, justifyContent: 'center' }}>
                                    ...
                                    <Image source={require('../../../Global/asset/Image/components/visa.png')} style={{ top: 15, left: 10, width: 20, height: 20, flex: 1, resizeMode: 'contain'}}/>
                                    <Image source={require('../../../Global/asset/Image/components/mastercard.png')} style={{ width: null, height: null, flex: 1, resizeMode: 'contain'}}/>
                                    </View>
                                </View>
                        </BoxShadow>
                    </View>
                        ...
                        <BoxShadow setting={shadowOpt}>
                            <View style={{ flex: 1 }}>
                                <View style={{flexDirection: 'row', backgroundColor: '#fff', height: 49, paddingLeft: 10, marginVertical: 5, borderRadius: 5, justifyContent: 'center' }}>
                                    ...
                                    <Image source={require('../../../Global/asset/Image/components/atmbersama.png')} style={{ top: 15, width: 20, height: 20, flex: 1, resizeMode: 'contain'}}/>
                                    <Image source={require('../../../Global/asset/Image/components/logo.png')} style={{ top: 15, width: 20, height: 20, flex: 1, resizeMode: 'contain'}}/>
                                    <Image source={require('../../../Global/asset/Image/components/prima.png')} style={{ top: 15, width: 20, height: 20, flex: 1, resizeMode: 'contain'}}/>
                                    <Image source={require('../../../Global/asset/Image/components/PermataBank.png')} style={{ top: 15, width: 20, height: 20, flex: 1, resizeMode: 'contain'}}/>
                                    </View>
                                </View>
                        </BoxShadow>
                        </View>
                        ...
                        <BoxShadow setting={shadowOpt}>
                            <View style={{ flex: 1 }}>
                                <View style={{ flexDirection: 'row', backgroundColor: '#fff', height: 49, paddingLeft: 10, marginVertical: 5, borderRadius: 5, justifyContent: 'center' }}>
                                    ...
                                    <Image source={require('../../../Global/asset/Image/components/klikbca.jpg')} style={{ top: 10, width: 30, height: 30, flex: 1, resizeMode: 'contain'}}/>
                                    </View>
                                </View>
                        </BoxShadow>
                        </View>
                            ...
                            <View style={{ flex: 1 }}>
                                <View style={{ flexDirection: 'row', backgroundColor: '#fff', height: 69, paddingLeft: 10, marginVertical: 5, borderRadius: 5, justifyContent: 'center' }}>
                                    <View style={{top: 15}}>
                                        ...
                                        <Image source={require('../../../Global/asset/Image/components/indomaret.png')} style={{ left: 10, top: 10, width: 40, height: 40, flex: 1, resizeMode: 'contain'}}/>
                                    </View>
                                </View>
                        </BoxShadow>
                        </View>
