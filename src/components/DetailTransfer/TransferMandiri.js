...
import { Text, View, StyleSheet, Dimensions, Image, ScrollView, AsyncStorage } from 'react-native';
                            ...
                            <View>
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <Badge style={style.BadgeInit}>
                                        <Text style={style.BadgeText}>{this.state.asal.code}</Text>
                                    </Badge>
                                    <Text style={style.DeparText}>{this.state.asal.city}</Text>
                                    <Icon name="long-arrow-alt-right" type="FontAwesome5" style={style.arrowRight} />
                                    <Badge style={style.BadgeInit2}>
                                        <Text style={style.BadgeText}>{this.state.tujuan.code}</Text>
                                    </Badge>
                                    <Text style={style.DeparText2}>{this.state.tujuan.code}</Text>
                                </View>
